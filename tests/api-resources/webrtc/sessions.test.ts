...
describe('resource sessions', () => {
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.webrtc.sessions.create({
      ...
      answer: { sdp: 'sdp' },
      callObjectRef: '84c742ba-a117-4e38-a089-1545073ce15c',
      ...
      serverCorrelator: '1492d270-8ca6-4367-9d1b-edd2fbd7f81b',
      status: 'Ringing',
    ...
    await expect(
      client.webrtc.sessions.updateStatus(
        'mediaSessionId',
        {
          answer: { sdp: 'sdp' },
          callObjectRef: '84c742ba-a117-4e38-a089-1545073ce15c',
          clientCorrelator: '1c1c3e8d-8f9d-4167-ac78-929ba0b21051',
