...
describe('resource subscriptions', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.devicelocation.subscriptions.retrieve('qs15-h556-rt89-1298');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.devicelocation.subscriptions.retrieve('qs15-h556-rt89-1298', { 'x-correlator': 'b4333c46-49c0-4f62-80d7-f0ef930f1c46' }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('list', async () => {
    const responsePromise = client.devicelocation.subscriptions.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.devicelocation.subscriptions.list({ 'x-correlator': 'b4333c46-49c0-4f62-80d7-f0ef930f1c46' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Camara.NotFoundError);
  });
  ...
  test.skip('delete', async () => {
    const responsePromise = client.devicelocation.subscriptions.delete('qs15-h556-rt89-1298');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.devicelocation.subscriptions.delete('qs15-h556-rt89-1298', { 'x-correlator': 'b4333c46-49c0-4f62-80d7-f0ef930f1c46' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Camara.NotFoundError);
  });
});
