...
describe('resource subscriptions', () => {
  ...
  test.skip('create: required and optional params', async () => {
    ...
    applicationServer: { ipv4Address: '192.168.0.1/24', ipv6Address: '2001:db8:85a3:8d3:1319:8a2e:370:7344' },
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.connectivityinsights.subscriptions.retrieve('qs15-h556-rt89-1298', { 'x-correlator': 'b4333c46-49c0-4f62-80d7-f0ef930f1c46' }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.connectivityinsights.subscriptions.list({ 'x-correlator': 'b4333c46-49c0-4f62-80d7-f0ef930f1c46' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Camara.NotFoundError);
  });
  ...
  test.skip('delete: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.connectivityinsights.subscriptions.delete('qs15-h556-rt89-1298', { 'x-correlator': 'b4333c46-49c0-4f62-80d7-f0ef930f1c46' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Camara.NotFoundError);
  });
});
