...
describe('logging', () => {
  ...
  connectedNetworkTypeNotificationsAPIKey: 'My Connected Network Type Notifications API Key',
    ...
    expect(client.logLevel).toBe('warn');
    expect(warnMock).toHaveBeenCalledWith('process.env[\'CAMARA_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]');
  });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['CAMARA_POPULATION_DENSITY_DATA_NOTIFICATIONS_API_KEY'] = 'My Population Density Data Notifications API Key';
    process.env['CAMARA_REGION_DEVICE_COUNT_NOTIFICATIONS_API_KEY'] = 'My Region Device Count Notifications API Key';
    process.env['CAMARA_CONNECTIVITY_INSIGHTS_NOTIFICATIONS_API_KEY'] = 'My Connectivity Insights Notifications API Key';
    process.env['CAMARA_SIM_SWAP_NOTIFICATIONS_API_KEY'] = 'My Sim Swap Notifications API Key';
    process.env['CAMARA_DEVICE_ROAMING_STATUS_NOTIFICATIONS_API_KEY'] = 'My Device Roaming Status Notifications API Key';
    process.env['CAMARA_DEVICE_REACHABILITY_STATUS_NOTIFICATIONS_API_KEY'] = 'My Device Reachability Status Notifications API Key';
    process.env['CAMARA_CONNECTED_NETWORK_TYPE_NOTIFICATIONS_API_KEY'] = 'My Connected Network Type Notifications API Key';
    const client = new Camara();
    ...
    expect(client.populationDensityDataNotificationsAPIKey).toBe('My Population Density Data Notifications API Key');
    expect(client.regionDeviceCountNotificationsAPIKey).toBe('My Region Device Count Notifications API Key');
    expect(client.connectivityInsightsNotificationsAPIKey).toBe('My Connectivity Insights Notifications API Key');
    expect(client.simSwapNotificationsAPIKey).toBe('My Sim Swap Notifications API Key');
    expect(client.deviceRoamingStatusNotificationsAPIKey).toBe('My Device Roaming Status Notifications API Key');
    expect(client.deviceReachabilityStatusNotificationsAPIKey).toBe('My Device Reachability Status Notifications API Key');
    expect(client.connectedNetworkTypeNotificationsAPIKey).toBe('My Connected Network Type Notifications API Key');
  });
  ...
  test('with overridden environment variable arguments', () => {
    ...
    process.env['CAMARA_DEVICE_LOCATION_NOTIFICATIONS_API_KEY'] = 'another My Device Location Notifications API Key';
    process.env['CAMARA_NOTIFICATIONS_API_KEY'] = 'another My Notifications API Key';
    process.env['CAMARA_POPULATION_DENSITY_DATA_NOTIFICATIONS_API_KEY'] = 'another My Population Density Data Notifications API Key';
    process.env['CAMARA_REGION_DEVICE_COUNT_NOTIFICATIONS_API_KEY'] = 'another My Region Device Count Notifications API Key';
    process.env['CAMARA_CONNECTIVITY_INSIGHTS_NOTIFICATIONS_API_KEY'] = 'another My Connectivity Insights Notifications API Key';
    process.env['CAMARA_SIM_SWAP_NOTIFICATIONS_API_KEY'] = 'another My Sim Swap Notifications API Key';
    process.env['CAMARA_DEVICE_ROAMING_STATUS_NOTIFICATIONS_API_KEY'] = 'another My Device Roaming Status Notifications API Key';
    process.env['CAMARA_DEVICE_REACHABILITY_STATUS_NOTIFICATIONS_API_KEY'] = 'another My Device Reachability Status Notifications API Key';
    process.env['CAMARA_CONNECTED_NETWORK_TYPE_NOTIFICATIONS_API_KEY'] = 'another My Connected Network Type Notifications API Key';
    const client = new Camara({
      bearerToken: 'My Bearer Token',
      customerInsightsToken: 'My Customer Insights Token',
      deviceSwapToken: 'My Device Swap Token',
