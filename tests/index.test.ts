...
describe('instantiate client', () => {
  ...
  test('with environment variable arguments', () => {
    ...
    expect(client.customerInsightsToken).toBe('My Bearer Token');
    expect(client.deviceSwapToken).toBe('My Bearer Token');
    expect(client.kycAgeVerificationToken).toBe('My Bearer Token');
    expect(client.kycFillInToken).toBe('My Bearer Token');
    expect(client.kycMatchToken).toBe('My Bearer Token');
    expect(client.tenureToken).toBe('My Bearer Token');
    expect(client.numberRecyclingToken).toBe('My Bearer Token');
    expect(client.otpValidationToken).toBe('My Bearer Token');
    expect(client.callForwardingSignalToken).toBe('My Bearer Token');
    expect(client.deviceLocationToken).toBe('My Bearer Token');
    expect(client.populationDensityDataToken).toBe('My Bearer Token');
    expect(client.regionDeviceCountToken).toBe('My Bearer Token');
    expect(client.webRtcToken).toBe('My Bearer Token');
    expect(client.connectivityInsightsToken).toBe('My Bearer Token');
    expect(client.qualityOnDemandToken).toBe('My Bearer Token');
    expect(client.deviceIdentifierToken).toBe('My Bearer Token');
    expect(client.simSwapToken).toBe('My Bearer Token');
    expect(client.deviceRoamingStatusToken).toBe('My Bearer Token');
    expect(client.deviceReachabilityStatusToken).toBe('My Bearer Token');
    expect(client.connectedNetworkTypeToken).toBe('My Bearer Token');
