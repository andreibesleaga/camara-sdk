...
import check_active_forwardings_callforwardingsignal from './callforwardingsignal/check-active-forwardings-callforwardingsignal';
import check_unconditional_forwarding_callforwardingsignal from './callforwardingsignal/check-unconditional-forwarding-callforwardingsignal';
...
import delete_webrtc_sessions from './webrtc/sessions/delete-webrtc-sessions';
...
addEndpoint(check_active_forwardings_callforwardingsignal);
addEndpoint(check_unconditional_forwarding_callforwardingsignal);
...
addEndpoint(delete_webrtc_sessions);
