...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/customerinsights/scoring/retrieve \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/deviceswap/retrieve-date \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"phoneNumber\": \"+34666111333\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/deviceswap/check \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"maxAge\": 120,\n          \"phoneNumber\": \"+34666111333\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ ageCheck: 'true' | 'false' | 'not_available'; contentLock?: 'true' | 'false' | 'not_available'; identityMatchScore?: number; parentalControl?: 'true' | 'false' | 'not_available'; verifiedStatus?: boolean; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara knowyourcustomerageverification verify \\\n  --bearer-token 'My Bearer Token' \\\n  --age-threshold 18"
      },
      "php": {
        "method": "knowyourcustomerageverification->verify",
      ...
      "http": {
        "example": "curl https://api.example.com/camara/knowyourcustomerageverification/verify \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"ageThreshold\": 18,\n          \"phoneNumber\": \"+34629255833\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Providing information related to a customer identity stored the account data bound to the customer's phone number.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/knowyourcustomerfill-in/fill-in \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"phoneNumber\": \"+34629255833\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/knowyourcustomermatch/match \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"phoneNumber\": \"+34629255833\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Verifies a specified length of tenure, based on a provided date, for a network subscriber to establish a level of trust for the network subscription identifier.\n",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/tenure/check-tenure \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"tenureDate\": \"2023-07-03\",\n          \"phoneNumber\": \"+123456789\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara numberrecycling check-subscriber-change \\\n  --bearer-token 'My Bearer Token' \\\n  --specified-date \"'2024-10-31'\""
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/numberrecycling/check \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"specifiedDate\": \"2024-10-31\",\n          \"phoneNumber\": \"+123456789\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara otpvalidation send-code \\\n  --bearer-token 'My Bearer Token' \\\n  --message '{{code}} is your short code to authenticate with Cool App via SMS' \\\n  --phone-number +346661113334"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/otpvalidation/send-code \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"message\": \"{{code}} is your short code to authenticate with Cool App via SMS\",\n          \"phoneNumber\": \"+346661113334\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/otpvalidation/validate-code \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"authenticationId\": \"ea0840f3-3663-4149-bd10-c7c6b8912105\",\n          \"code\": \"AJY3\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara callforwardingsignal check-unconditional-forwarding \\\n  --bearer-token 'My Bearer Token'"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/callforwardingsignal/unconditional-call-forwardings \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"phoneNumber\": \"+123456789\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara callforwardingsignal check-active-forwardings \\\n  --bearer-token 'My Bearer Token'"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/callforwardingsignal/call-forwardings \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"phoneNumber\": \"+123456789\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; config: { initialEvent?: boolean; subscriptionExpireTime?: string; subscriptionMaxEvents?: number; }; protocol: 'HTTP' | 'MQTT3' | 'MQTT5' | 'AMQP' | 'NATS' | 'KAFKA'; sink: string; startsAt: string; types: string[]; expiresAt?: string; status?: 'ACTIVATION_REQUESTED' | 'ACTIVE' | 'EXPIRED' | 'INACTIVE' | 'DELETED'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/devicelocation/subscriptions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"config\": {\n            \"initialEvent\": true,\n            \"subscriptionExpireTime\": \"2024-03-22T05:40:58.469Z\",\n            \"subscriptionMaxEvents\": 10,\n            \"subscriptionDetail\": {\n              \"area\": {\n                \"areaType\": \"CIRCLE\"\n              },\n              \"device\": {\n                \"phoneNumber\": \"+12345678912\"\n              }\n            }\n          },\n          \"protocol\": \"HTTP\",\n          \"sink\": \"https://notificationSendServer12.supertelco.com\",\n          \"types\": [\n            \"org.camaraproject.geofencing-subscriptions.v0.area-entered\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; config: object; protocol: 'HTTP' | 'MQTT3' | 'MQTT5' | 'AMQP' | 'NATS' | 'KAFKA'; sink: string; startsAt: string; types: string[]; expiresAt?: string; status?: 'ACTIVATION_REQUESTED' | 'ACTIVE' | 'EXPIRED' | 'INACTIVE' | 'DELETED'; }[]",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara devicelocation:subscriptions retrieve \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/devicelocation/subscriptions/$SUBSCRIPTION_ID \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara devicelocation:subscriptions delete \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
  ...
  },
  {
    ...
    "response": "{ status: 'SUPPORTED_AREA' | 'PART_OF_AREA_NOT_SUPPORTED' | 'AREA_NOT_SUPPORTED' | 'OPERATION_NOT_COMPLETED'; timedPopulationDensityData: { cellPopulationDensityData: { dataType: 'NO_DATA' | 'LOW_DENSITY' | 'DENSITY_ESTIMATION'; geohash: string; }[]; endTime: string; startTime: string; }[]; statusInfo?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/populationdensitydata/retrieve \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"area\": {\n            \"areaType\": \"POLYGON\"\n          },\n          \"endTime\": \"2024-04-23T14:44:18.165Z\",\n          \"startTime\": \"2024-04-23T14:44:18.165Z\",\n          \"sink\": \"https://endpoint.example.com/sink\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/regiondevicecount/count \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"endtime\": \"2023-07-04T14:27:08.312+02:00\",\n          \"sink\": \"https://endpoint.example.com/sink\",\n          \"starttime\": \"2023-07-03T14:27:08.312+02:00\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara webrtc:sessions create \\\n  --bearer-token 'My Bearer Token' \\\n  --registration-id registrationId"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/webrtc/sessions \\\n    -X POST \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara webrtc:sessions retrieve \\\n  --bearer-token 'My Bearer Token' \\\n  --media-session-id mediaSessionId"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/webrtc/sessions/$MEDIA_SESSION_ID \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara webrtc:sessions delete \\\n  --bearer-token 'My Bearer Token' \\\n  --media-session-id mediaSessionId"
      },
      "php": {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara webrtc:sessions update-status \\\n  --bearer-token 'My Bearer Token' \\\n  --media-session-id mediaSessionId"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/webrtc/sessions/$MEDIA_SESSION_ID/status \\\n    -X PUT \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/connectivityinsights/subscriptions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"config\": {\n            \"subscriptionDetail\": {\n              \"applicationProfileId\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n              \"device\": {}\n            }\n          },\n          \"protocol\": \"HTTP\",\n          \"sink\": \"https://endpoint.example.com/sink\",\n          \"types\": [\n            \"org.camaraproject.connectivity-insights-subscriptions.v0.network-quality\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ config: object; protocol: 'HTTP' | 'MQTT3' | 'MQTT5' | 'AMQP' | 'NATS' | 'KAFKA'; sink: string; startsAt: string; types: 'org.camaraproject.connectivity-insights-subscriptions.v0.network-quality'[]; expiresAt?: string; status?: 'ACTIVATION_REQUESTED' | 'ACTIVE' | 'EXPIRED' | 'DEACTIVE' | 'DELETED'; subscriptionId?: string; }[]",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions retrieve",
        "example": "camara connectivityinsights:subscriptions retrieve \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/connectivityinsights/subscriptions/$SUBSCRIPTION_ID \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions delete",
        "example": "camara connectivityinsights:subscriptions delete \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/qualityondemand/retrieve-qos-profiles \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"name\": \"voice\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "camara qualityondemand retrieve-qos-profile \\\n  --bearer-token 'My Bearer Token' \\\n  --name voice"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/qualityondemand/qos-profiles/$NAME \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/deviceidentifier/retrieve-identifier \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/deviceidentifier/retrieve-type \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/deviceidentifier/retrieve-ppid \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/simswap/subscriptions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"config\": {\n            \"subscriptionDetail\": {\n              \"phoneNumber\": \"+123456789\"\n            },\n            \"subscriptionExpireTime\": \"2025-01-17T13:18:23.682Z\",\n            \"subscriptionMaxEvents\": 10\n          },\n          \"protocol\": \"HTTP\",\n          \"sink\": \"https://endpoint.example.com/sink\",\n          \"types\": [\n            \"org.camaraproject.sim-swap-subscriptions.v0.swapped\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; config: object; protocol: 'HTTP' | 'MQTT3' | 'MQTT5' | 'AMQP' | 'NATS' | 'KAFKA'; sink: string; types: 'org.camaraproject.sim-swap-subscriptions.v0.swapped'[]; expiresAt?: string; startsAt?: string; status?: 'ACTIVATION_REQUESTED' | 'ACTIVE' | 'EXPIRED' | 'INACTIVE' | 'DELETED'; }[]",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions retrieve",
        "example": "camara simswap:subscriptions retrieve \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/simswap/subscriptions/$SUBSCRIPTION_ID \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions delete",
        "example": "camara simswap:subscriptions delete \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
  ...
  },
  {
    ...
    "response": "{ id: string; config: { subscriptionDetail: object; initialEvent?: boolean; subscriptionExpireTime?: string; subscriptionMaxEvents?: number; }; protocol: 'HTTP' | 'MQTT3' | 'MQTT5' | 'AMQP' | 'NATS' | 'KAFKA'; sink: string; types: string[]; expiresAt?: string; startsAt?: string; status?: 'ACTIVATION_REQUESTED' | 'ACTIVE' | 'EXPIRED' | 'INACTIVE' | 'DELETED'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/deviceroamingstatus/subscriptions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"config\": {\n            \"subscriptionDetail\": {\n              \"device\": {\n                \"phoneNumber\": \"+123456789\"\n              }\n            },\n            \"initialEvent\": true,\n            \"subscriptionExpireTime\": \"2023-01-17T13:18:23.682Z\",\n            \"subscriptionMaxEvents\": 5\n          },\n          \"protocol\": \"HTTP\",\n          \"sink\": \"https://endpoint.example.com/sink\",\n          \"types\": [\n            \"org.camaraproject.device-roaming-status-subscriptions.v0.roaming-status\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; config: object; protocol: 'HTTP' | 'MQTT3' | 'MQTT5' | 'AMQP' | 'NATS' | 'KAFKA'; sink: string; types: string[]; expiresAt?: string; startsAt?: string; status?: 'ACTIVATION_REQUESTED' | 'ACTIVE' | 'EXPIRED' | 'INACTIVE' | 'DELETED'; }[]",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions retrieve",
        "example": "camara deviceroamingstatus:subscriptions retrieve \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/deviceroamingstatus/subscriptions/$SUBSCRIPTION_ID \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions delete",
        "example": "camara deviceroamingstatus:subscriptions delete \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/devicereachabilitystatus/subscriptions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\" \\\n    -d '{\n          \"config\": {\n            \"subscriptionDetail\": {\n              \"device\": {\n                \"phoneNumber\": \"+123456789\"\n              }\n            },\n            \"initialEvent\": true,\n            \"subscriptionExpireTime\": \"2023-01-17T13:18:23.682Z\",\n            \"subscriptionMaxEvents\": 5\n          },\n          \"protocol\": \"HTTP\",\n          \"sink\": \"https://endpoint.example.com/sink\",\n          \"types\": [\n            \"org.camaraproject.device-reachability-status-subscriptions.v0.reachability-data\"\n          ]\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions retrieve",
        "example": "camara devicereachabilitystatus:subscriptions retrieve \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/devicereachabilitystatus/subscriptions/$SUBSCRIPTION_ID \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions delete",
        "example": "camara devicereachabilitystatus:subscriptions delete \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
  ...
  },
  {
    ...
    "response": "{ id: string; config: object; protocol: 'HTTP' | 'MQTT3' | 'MQTT5' | 'AMQP' | 'NATS' | 'KAFKA'; sink: string; types: 'org.camaraproject.connected-network-type-subscriptions.v0.network-type-changed'[]; expiresAt?: string; startsAt?: string; status?: 'ACTIVATION_REQUESTED' | 'ACTIVE' | 'EXPIRED' | 'INACTIVE' | 'DELETED'; }[]",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions retrieve",
        "example": "camara connectednetworktype:subscriptions retrieve \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
      ...
      "http": {
        "example": "curl https://api.example.com/camara/connectednetworktype/subscriptions/$SUBSCRIPTION_ID \\\n    -H \"Authorization: Bearer $CAMARA_BEARER_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "subscriptions delete",
        "example": "camara connectednetworktype:subscriptions delete \\\n  --bearer-token 'My Bearer Token' \\\n  --subscription-id qs15-h556-rt89-1298"
      },
      "php": {
