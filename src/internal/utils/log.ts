...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Camara): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Camara): Logger {
